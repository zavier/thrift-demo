...
public class UserSearchResult implements org.apache.thrift.TBase<UserSearchResult, UserSearchResult._Fields>, java.io.Serializable, Cloneable, Comparable<UserSearchResult> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new UserSearchResultStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new UserSearchResultTupleSchemeFactory();
  ...
  public UserSearchResult setUsers(@org.apache.thrift.annotation.Nullable java.util.List<User> users) {
    this.users = users;
    return this;
  }
  ...
  public int compareTo(UserSearchResult other) {
    ...
    lastComparison = Boolean.compare(isSetUsers(), other.isSetUsers());
    if (lastComparison != 0) {
  ...
  private static class UserSearchResultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public UserSearchResultStandardScheme getScheme() {
      return new UserSearchResultStandardScheme();
    }
  }

  private static class UserSearchResultStandardScheme extends org.apache.thrift.scheme.StandardScheme<UserSearchResult> {
  ...
  private static class UserSearchResultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public UserSearchResultTupleScheme getScheme() {
      return new UserSearchResultTupleScheme();
    }
  }

  private static class UserSearchResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<UserSearchResult> {
